            ...
            <div class="ng-inmod-ini">
                <div class="ng-fault ng-container">
                    <div class="ng-inmod-the ng-container ng-bg-fff">
                        ...
                        <span class="ng-inmod-the-cn" aos="fade-down">公司简介展示</span>
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="gongshijianjieSeachName" id="gongshijianjieSeachName" placeholder="公司名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                        ...
                        <div class="article-list">
                            <ul class="after">
                                <li v-for="(item,index) in dataList" v-bind:key="index">
                                    <a target="_self" :href="'../gongshijianjieSeach/detail.jsp?id='+item.id">
                                        <img width="180" class="fl" :src="item.gongshijianjieSeachPhoto" />
                                        <h5>{{item.gongshijianjieSeachName}}</h5>
                                        <p class="time-sour">
                                            <span>发布时间：{{item.insertTime}} </span>
                                        </p>
                                        <p class="reamk">{{item.gongshijianjieSeachContent|gongshijianjieSeachContent}}...</p>
                                    </a>
                                </li>
                            </ul>
                            <div class="pages">
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 gongshijianjieSeachContent 字段去除无用字符 如果字段长度大于60  就截取到60
            gongshijianjieSeachContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#gongshijianjieSeachName').val() != null && jquery('#gongshijianjieSeachName').val() != "" && jquery('#gongshijianjieSeachName').val() != "null" ) {
                param['gongshijianjieSeachName'] = jquery('#gongshijianjieSeachName').val();
            }
                            // 获取列表数据
            http.request('gongshijianjieSeach/list', 'get', param, function(res) {
