                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="tuanduiName" id="tuanduiName" placeholder="团队名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                    ...
                    <ul>
                        <li v-for="(item,index) in dataList" v-bind:key="index">
                            <div class="ng-prslist-doc">
                                <div class="ng-prslist-img" @click="jump('../tuandui/detail.jsp?id='+item.id)">
                                    <a href="#" class="ng-prsliik">
                                        <span class="ng-prsliik-ki ng-prsliik-ki_1">
                                            <img class="swiper-item" :src="item.tuanduiPhoto?item.tuanduiPhoto.split(',')[0]:''" />
                                        </span>
                                ...
                                <div class="ng-prslist-tit" @click="jump('../tuandui/detail.jsp?id='+item.id)"><span>{{item.tuanduiName}}</span></div>
                                <div class="ng-prslist-tit" v-if="item.tuanduiNewMoney"><span style="color: red;">{{item.tuanduiNewMoney}} RMB</span></div>
                            </div>
                        </li>
                    </ul>
                </div>
...
<script>
    var vue = new Vue({
        ...
        filters: {
            //把 tuanduiContent 字段去除无用字符 如果字段长度大于60  就截取到60
            tuanduiContent: function(val) {
                if (val) {
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage','form', 'http', 'jquery', 'laydate'], function() {
        ...
        function pageList() {
            ...
            if (jquery('#tuanduiName').val() != null && jquery('#tuanduiName').val() != "" && jquery('#tuanduiName').val() != "null" ) {
                param['tuanduiName'] = jquery('#tuanduiName').val();
            }
                                                                            // 获取列表数据
            http.request('tuandui/list', 'get', param, function(res) {
